...
const MessageIcon = ()=>{
    ...
    return (
        <section className="w-full h-20vh p-4">
            <svg className="float-right text-white cursor-pointer" onClick={handleClicker} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
